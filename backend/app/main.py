...
app.add_middleware(
    ...
    allow_origins=[
        *settings.ALLOWED_ORIGINS,
        "https://clovio-platform-git-new-version-punsararajapaksa-8532s-projects.vercel.app",
    ],
    # Allow local development origins on non-default ports (e.g. Vite fallback ports).
